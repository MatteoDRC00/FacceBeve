                    ...
                    <div class="row">
                        <div class="col-12 bg-white p-0 px-3 py-3 mb-3">
                            <div class="d-flex flex-column align-items-center">
                                {if $type=="" && $pic64==""}
                                    <img class="photo" src="/FacceBeve/template/img/utente.jpg" alt="immagine profiloooo">
                                {else}
                ...
                <div class="col-md-7 ps-md-4">
                    <div class="row">
                        ...
                        <div class="col-12 bg-white px-3 pb-2">
                            <form action="/FacceBeve/Profilo/modificaImmagineProfilo" enctype="multipart/form-data" method="POST" name="modificaImg" class="aggiorna" onclick=" return validateImg()">
                            ...
                            {if !empty($locali_preferiti)}
                                <ul>
                                    {foreach $locali_preferiti as $locale}
                                        <li style="font-size: 24px"><a href="/FacceBeve/Ricerca/dettagliLocale/{$locale->getID()}">{$locale->getNome()}   <i class="fa fa-angle-right"></i></a></li>
                                    {/foreach}
                                </ul>
                            {else}
