    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="gestioneutente">
                <a href="/FacceBeve/GestioneEvento/mostraFormCreaEvento/{$locale->getId()}">Aggiungi evento</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 bg-white px-3 mb-3 pb-3">
                    <form action="/FacceBeve/GestioneLocale/modificaNomeLocale/{$locale->getId()}" method="POST" class="aggiorna">
                    ...
                    <form action="/FacceBeve/GestioneLocale/modificaDescrizioneLocale/{$locale->getId()}" method="POST" class="aggiorna">
                        <div class="form-example">
                    ...
                    <form action="/FacceBeve/GestioneLocale/modificaCategorieLocale/{$locale->getId()}" method="POST" class="aggiorna" id="modificaGenere" onsubmit="return validatemodificaGeneriForm()">
                        <div class="form-example">
                    ...
                    <form action="/FacceBeve/GestioneLocale/modificaNumTelefonoLocale/{$locale->getId()}" method="POST" class="aggiorna">
                        <div class="form-example">
                    ...
                    <form action="/FacceBeve/GestioneLocale/modificaLocalizzazioneLocale/{$locale->getId()}" method="POST" class="aggiorna">
                        <div class="form-example">
                    ...
                    <form action="/FacceBeve/GestioneLocale/modificaOrarioLocale/{$locale->getId()}" method="POST" class="aggiorna" id="modificaOrario" onsubmit="return validateModificaOrarioForm()">
                        <div class="form-example">
                ...
                <div class="col-6 bg-white px-3 mb-3 pb-3">
                    <form action="/FacceBeve/GestioneLocale/addImmagineLocale/{$locale->getId()}" enctype="multipart/form-data" method="POST" class="aggiorna"> <!-- aggiungin i controlli -->
                    ...
                    {if !empty(($immagini))}
                        {foreach $immagini as $img}
                            <form action="/FacceBeve/GestioneLocale/eliminaImmagineLocale/{$img->getId()}" method="POST" class="aggiorna"> <!-- aggiungin i controlli -->
                        ...
                        {foreach $eventi as $evento}
                            <li style="padding: 3px;">
                                <div class="items-body-content row-cols-3">
                                    <p>{$evento->getNome()}</p>
                                    <a href="/FacceBeve/GestioneEvento/mostraFormGestioneEvento/{$evento->getId()}"><input type="button" value="Gestisci evento"></a>
                                    <a href="/FacceBeve/GestioneEvento/eliminaEvento/{$evento->getId()}"><input type="button" value="Elimina evento"></a>
                                </div>
                            </li>
                        {/foreach}
                    </ul>
