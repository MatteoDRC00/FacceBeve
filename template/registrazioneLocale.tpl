        ...
        <div class="container">
            <div class="row">
                <div class="col-12 bg-white px-3 mb-3 pb-3">
                    <form action="/FacceBeve/GestioneLocale/creaLocale" enctype="multipart/form-data" method="POST" class="aggiorna" id="registrazioneLocale" onsubmit="return validateRegForm(2)">
