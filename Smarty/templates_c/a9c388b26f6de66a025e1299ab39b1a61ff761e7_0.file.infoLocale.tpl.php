<?php
/* Smarty version 4.2.0, created on 2022-09-08 10:53:32
  from 'C:\xampp\htdocs\FacceBeve\Smarty\templates\infoLocale.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_6319ad8c85ed69_49789875',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a9c388b26f6de66a025e1299ab39b1a61ff761e7' => 
    array (
      0 => 'C:\\xampp\\htdocs\\FacceBeve\\Smarty\\templates\\infoLocale.tpl',
      1 => 1662567644,
      2 => 'file',
    ),
  ),
...
function content_6319ad8c85ed69_49789875 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="portfolio-details-slider swiper">
                        ...
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="/Smarty/template/assets/img/portfolio/portfolio-1.jpg" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="/Smarty/template/assets/img/portfolio/portfolio-2.jpg" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="/Smarty/template/assets/img/portfolio/portfolio-3.jpg" alt="">
                            </div>
                ...
                <div class="col-lg-8 entries">
                    ...
                    <div class="blog-comments">
                        ...
                        <div id="comment-1" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="/Smarty/template/assets/img/blog/comments-1.jpg" alt=""></div>
                                <div>
                        ...
                        <div id="comment-2" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="/Smarty/template/assets/img/blog/comments-2.jpg" alt=""></div>
                                <div>
                            ...
                            <div id="comment-reply-1" class="comment comment-reply">
                                <div class="d-flex">
                                    <div class="comment-img"><img src="/Smarty/template/assets/img/blog/comments-3.jpg" alt=""></div>
                                    <div>
                                ...
                                <div id="comment-reply-2" class="comment comment-reply">
                                    <div class="d-flex">
                                        <div class="comment-img"><img src="/Smarty/template/assets/img/blog/comments-4.jpg" alt=""></div>
                                        <div>
                        ...
                        <div id="comment-3" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="/Smarty/template/assets/img/blog/comments-5.jpg" alt=""></div>
                                <div>
                        ...
                        <div id="comment-4" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="/Smarty/template/assets/img/blog/comments-6.jpg" alt=""></div>
                                <div>
