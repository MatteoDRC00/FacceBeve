<?php
/* Smarty version 4.2.0, created on 2022-09-13 17:47:34
  from 'C:\xampp\htdocs\FacceBeve\template\registrazioneUtente.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_6320a616880ac9_77875424',
...
function content_6320a616880ac9_77875424 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
<div class="login-page">
    <div class="form">
        <form class="login-form" action="/Accesso/registrazioneUtente" enctype="multipart/form-data" method="POST" name="registrazioneUtente" onsubmit="return validateRegForm(0)">
            ...
            <input type="text" placeholder="email" name="email"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Deve essere incluso @"/>
            <input type="text" placeholder="username" name="username"/>
            <input type="password" placeholder="password"  name="password1"pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="La password deve contenere almeno 8 caratteri, di cui almeno una lettera maiuscola"/>
